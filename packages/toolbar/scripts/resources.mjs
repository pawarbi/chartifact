...
const resources = {
  htmlJson: path.resolve(__dirname, '../../toolbar-resources/html/html-json.html'),
  htmlJsonJs: path.resolve(__dirname, '../../toolbar-resources/dist/html-json.js'),
  htmlMarkdown: path.resolve(__dirname, '../../toolbar-resources/html/html-markdown.html'),
  htmlMarkdownJs: path.resolve(__dirname, '../../toolbar-resources/dist/html-markdown.js'),
};
